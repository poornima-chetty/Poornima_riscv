...
Read-After-Write (RAW) Hazard: An instruction attempts to read a register or memory location that a previous instruction is still in the process of writing to.
Write-After-Read (WAR) Hazard: An instruction attempts to write to a register or memory location that a subsequent instruction is reading from.
Write-After-Write (WAW) Hazard: Two instructions attempt to write to the same register or memory location in close succession.
Control Hazards
...
|cpu
      ...
      m4+cpu_viz(@4)    // For visualisation
```
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/d1d9452f-cc71-427d-89ca-0f955160420c)

![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/1c7a06c2-685c-42b6-819e-2bb01a7cb220)
Taking care of Invalid Cycles
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/6668462f-3f5b-47ea-adb5-2fc65295c606)
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/c682109b-f796-4415-a284-039b015823bb)
...
```
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/ffd63323-9336-48de-a2a2-ab1575649ca7)

![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/80839b99-32c3-4321-8f90-5c20638c1eeb)
...
|cpu
      ...
      m4+cpu_viz(@4)    // For visualisation
```
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/10c8d31e-6416-46d2-9ee0-b01b9a3ce6f6)
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/9bdabc14-4c20-4015-adc5-e6f86b118ea3)
...
|cpu
      ...
      m4+cpu_viz(@4)    // For visualisation
```
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/62b6a4c0-da7c-4f6b-9a4f-78a7336a4d0d)
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/a5ab08e6-e5a0-4b26-a4c3-443bd694e33a)
...
|cpu
      ...
      m4+cpu_viz(@4)    // For visualisation
```
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/a987e983-bac2-4e13-a856-564dfaa5cb90)
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/ce458e5c-10f2-43f4-afc5-f296784c1fb5)
Complete ALU
```|cpu
      @0
         $reset = *reset;
...
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/65819e43-4fe6-4d5f-813d-df7580eeafbf)
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/6b87c41e-0793-4a86-8651-f7287c343c1a)
Labs
...
```
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/8af435a8-e911-42a3-a012-bf717fb43dd5)
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/8bc181aa-63c1-45d5-977d-887e6cf89820)
...
```
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/801e4a97-de7c-4f2b-bb91-9f2eb0b61635)
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/28ae6b9b-02e8-448d-a86c-c832b22bbb3f)
ab to Instantiate Data Memory to CPU
```
|cpu
      @0
         $reset = *reset;
...
|cpu
      ...
      m4+cpu_viz(@4)    // For visualisation
```
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/11f84e29-2e5b-473c-89e9-c4d2c565a909)
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/8db1bcc1-543d-4917-906d-506fa66bb35b)
...
```
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/910dc202-e922-4de5-9cc6-939d75225d74)
![image](https://github.com/poornima-chetty/Poornima_riscv/assets/142583396/26f93e75-cef2-4c2b-9344-87f360a72ef2)
